...
|--------|---------------|-----------|
| `routing` | Route definitions and navigation (React Router) | FR-1 |
...
### D1: Routing — React Router v6

| Chosen | Discarded | Justification |
|--------|-----------|---------------|
| React Router Domv6 | Next.js | Constitution §1 fixes stack to React + TypeScript. SPA routing sufficient for 3 static pages. |
| React Router v6 | TanStack Router | React Router is more widely known; TanStack Router overkill for 3 routes. |
...
| Chosen | Discarded | Justification |
|--------|-----------|---------------|
| CSS Modules | Bootstrap | Constitution §7 restricts new dependencies. CSS Modules ship with React tooling, zero config. Bootstrap would require new dependency. |
